...
<h3 id="comments-title" class="h2"><?php comments_number( __( 'No Comments', 'wpf-authority' ), __( '1 Comment', 'wpf-authority' ), _n( '% Comment', '% Comments', get_comments_number(), 'wpf-authority' ) );?></h3>
